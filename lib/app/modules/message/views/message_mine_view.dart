...
class MessageMineView extends GetView<MessageController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Mes Messages envoyés",
          style: TextStyle(
              fontSize: 18.0,
              color: Colors.white,
                ...
                child: Center(
                  child: ListView(
                    ...
                    children: [
                      Obx(()=>Row(
                        children: [
                          if(controller.myMessagesTypesList.length == 0)
                            Container()
                          else
                          for(var type in controller.myMessagesTypesList) Card(
                            elevation: 0.0,
                            child: InkWell(
                              onTap: () async{
                                if(controller.selectedType.value == '' || controller.selectedType.value != type.nom){
                                  ...
                                  await controller.getMyMessagesByType(controller.selectedMessageType.value.id);
                                }else{
                                  controller.refresh();
                                }
                              },
