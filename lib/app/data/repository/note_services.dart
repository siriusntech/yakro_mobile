...
class NoteServices {
  ...
  static Future<Object> getMoyenneHotel(id) async {

    final apiUrl = settingsCtrl.baseUrl+'moyenneHotel';
    try{
      var headers = await AuthService.getLoggedHeaders();
      var url = Uri.parse(apiUrl+'/$id');
      var response = await http.get(url, headers: headers);
      print('response Notes: '+response.body.toString());
      print('response Notes id: '+id.toString());
