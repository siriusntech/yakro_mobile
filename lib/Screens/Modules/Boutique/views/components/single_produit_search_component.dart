...
class SingleProduitSearchComponent extends StatefulWidget {
  const SingleProduitSearchComponent({super.key, this.produitBoutiqueModel});
  final ProduitBoutiqueModel? produitBoutiqueModel;
  @override
  State<SingleProduitSearchComponent> createState() =>
      _SingleProduitSearchComponentState();
}

class _SingleProduitSearchComponentState
    extends State<SingleProduitSearchComponent> {
  @override
                  ...
                  children: [
                    SizedBox(
                      child: Row(
                        ...
                        children: [
                          Text('${widget.produitBoutiqueModel!.prix} FCFA',
                              textAlign: TextAlign.start,
                              style: const TextStyle(
                                  fontWeight: FontWeight.w800, fontSize: 25)),
                          Text('Qté: ${widget.produitBoutiqueModel!.quantite}',
                              textAlign: TextAlign.start,
                              style: const TextStyle(
                                  fontWeight: FontWeight.w800, fontSize: 25)),
                        ],
                    ...
                    Obx(() => commerceController
                        ...
                        ? InkWell(
                            onTap: () {
                              commerceController.controllerCartScreen.addToCart(
                                  widget.produitBoutiqueModel!,
                                  commerceController
                                      .controllerBoutique.orderNumber.value);
                              Get.back();
                              commerceController.setFloatingDisable(false);
                            },
                            child: Container(
