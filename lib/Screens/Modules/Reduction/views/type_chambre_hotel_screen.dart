                      ...
                      Expanded(
                        child: ListView.separated(
                            itemBuilder: (context, index) {
                              final isSelected =
                                  controller.selectedIndex.value ==
                                      controller.hotelModel
                                          .typeChambreHotels![index].id;
                              return GestureDetector(
                                  onTap: () {
                                    controller.selectIndex(int.parse(controller
                                        .hotelModel.typeChambreHotels![index].id
                                        .toString()));
                                    controller.setChambreHotel(controller
                                        .hotelModel.typeChambreHotels![index]);
                                  },
                                  child: SizedBox(
                                    height: 200,
                                    child: Card(
                            ...
                            itemCount: controller
                                .hotelModel.typeChambreHotels!.length),
                      ),
                      controller.typeChambreHotel != null
                          ? SizedBox(
                              height: 50,
                              width: width,
                              child: ElevatedButton(
                                onPressed: () {
                                  if (controller.typeChambreHotel == null) {
                                  ...
                                  controller.controllerReservation.setAuthModel(
