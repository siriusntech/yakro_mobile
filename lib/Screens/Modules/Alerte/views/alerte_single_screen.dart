...
class AlerteSingleScreen extends GetView<AlerteSingleScreenController> {
  const AlerteSingleScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        bottomSheet: Container(
          ...
          decoration: BoxDecoration(color: controller.colorSecondary.value),
          child: TextFormField(
                        ...
                        child: ListView.separated(
                            itemBuilder: (conttext, index) => Container(
                                  ...
                                  child: Row(
                                    children: [
                                      const CircleAvatar(
                                        backgroundColor: Color(0xff9A241A),
                                      ),
                                      const SizedBox(
                                        width: 10,
                                      ),
